...
**Purpose:** Rapid iteration with bind-mounted volumes (code changes reflect instantly)

**Architecture:**
- Docker Compose orchestrates all services
- Nginx reverse proxy (single entry point)
- Volumes: `data/`, `models/`, `metrics/`, `pipeline/` mounted live

**When to use:** 
- ✅ Development and debugging
- ✅ Testing pipeline changes
- ❌ Production deployment (use `make build` instead)
